...
## 予防的統制に寄与するAWSサービス
予防的統制は、セキュリティインシデントが発生する前にリスクを最小限に抑えることを目的としています。AWSの以下のサービスは予防的統制に該当します。

### AWS IAM (Identity and Access Management)
ユーザー、グループ、ロールに対して細かいアクセス権限を設定し、不正アクセスのリスクを低減します。

### AWS WAF (Web Application Firewall)
ウェブアプリケーションを一般的なウェブ攻撃から保護し、セキュリティを強化します。

### AWS Shield
DDoS攻撃からの包括的な保護を提供し、攻撃対応サポートを強化します。
