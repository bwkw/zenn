...
# デザインパターンの紹介
ここからが本題です。大抵の場合、上の例で示したようなAPI設計で十分です。ただ、いくつかの複雑な要件では、上の例で示したようなAPI設計では良いAPIを設計するための4つの特性を満たすことが出来ず、デザインパターンが必要になることがあります。
...
私自身、デザインパターンを知らないあまり、強引にAPIを設計していたことも多々あったな...と考えさせられましたし、API設計を考える上でこういう設計方法もあるんだな〜っていう一つのとっかかりが出来たという意味で読んで価値ある本だったなと思いました。
