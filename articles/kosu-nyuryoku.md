...
現在、上記の課題を踏まえ、営業メンバーの日々の工数記録と集計作業を効率化するために Google Calendar と連携し、予定作成時に工数データも同時に入力できる Chrome 拡張機能を開発しています。実際の挙動は以下です。
...
今回は、営業組織の拡大に伴う「運用工数の可視化」という課題に対して、どのように Chrome 拡張機能を活用して解決を目指しているかを紹介しました。この拡張機能は、Google Calendar との連携を通じて、営業メンバーの日々の業務記録を効率化し、集計作業の負担を大幅に軽減することを目的としています。
